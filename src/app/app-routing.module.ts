...
const routes: Routes = [
  ...
  { path: 'laudos/page2', component: Pagina2Component, canActivate: [LoginComponent] },
  { path: 'pag3', component: Pag3Component , canActivate: [LoginComponent] },  // Faça um teste  com uma terceira rota
